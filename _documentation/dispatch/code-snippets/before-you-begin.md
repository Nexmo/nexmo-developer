...
The Code Snippets utilise code from the [Nexmo Node Quickstart](https://github.com/nexmo-community/nexmo-node-quickstart) and [Curl Code Snippet](https://github.com/Nexmo/curl-building-blocks) repositories.
