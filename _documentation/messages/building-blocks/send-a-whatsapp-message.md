...
> **NOTE:** The first time you send a message to a user, WhatsApp requires that message contains a template. This is explained in more detail in the [Understanding WhatsApp topic](/messages/concepts/whatsapp).
